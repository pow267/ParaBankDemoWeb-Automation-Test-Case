...
public class AdminControllerTest extends AbstractValidatingBankControllerTest<AdminController> {
    ...
    public void testHandleGetRequest() throws Exception {
        ...
        final AdminForm form = (AdminForm) Objects.requireNonNull(mav.getModel()).get(getFormName());
    ...
    public void testOnSubmit() throws Exception {
        ...
        assertEquals("settings.saved", Objects.requireNonNull(Objects.requireNonNull(mav.getModel()).get("message")).toString());
    }
