...
public class BillPayControllerSpringTest {
    ...
    public void testHandleGetRequest() throws Exception
    {
        ...
        mockMvc.perform(get(PATH)
            .sessionAttr(Constants.USERSESSION, new UserSession(customer)))
                ...
                .andExpect(model().attributeExists(Constants.BILLPAYFORM))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attribute("accounts", Objects.requireNonNull(iterableWithSize(11))));
    }
        ...
        throws Throwable
    {
        mockMvc.perform(post(PATH)
            ...
            .sessionAttr(Constants.BILLPAYFORM, Objects.requireNonNull(getBillPayForm()))
            .sessionAttr(Constants.USERSESSION, new UserSession(new Customer())))
                .andExpect(status().isOk())
    ...
    public void testValidate() throws Exception
    {
        ...
        mockMvc.perform(post(PATH)
            .contentType(Objects.requireNonNull(MediaType.APPLICATION_FORM_URLENCODED))
            .sessionAttr(Constants.BILLPAYFORM, Objects.requireNonNull(form))
            .sessionAttr(Constants.USERSESSION, new UserSession(new Customer())))
