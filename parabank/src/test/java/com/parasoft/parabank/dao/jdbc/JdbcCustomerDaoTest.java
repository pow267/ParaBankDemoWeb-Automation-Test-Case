...
public class JdbcCustomerDaoTest extends AbstractParaBankDataSourceTest {
    ...
    private void defaultCustomerTest(final Customer customer) {
        assertEquals(12212, Objects.requireNonNull(customer).getId());
        assertEquals("John", customer.getFirstName());
        assertEquals("Smith", customer.getLastName());
        assertEquals("1431 Main St", Objects.requireNonNull(customer.getAddress()).getStreet());
    ...
    public void testCreateCustomer() {
        final int id = Objects.requireNonNull(customerDao).createCustomer(Objects.requireNonNull(customer));
    ...
    public void testGetCustomer() {
        Customer customer = Objects.requireNonNull(customerDao).getCustomer(12212);
    ...
    public void testGetCustomerBySSN() {
        final Customer customer = Objects.requireNonNull(customerDao).getCustomer("622-11-9999");
        defaultCustomerTest(customer);
    ...
    public void testGetCustomerByUsername() {
        final Customer customer = Objects.requireNonNull(customerDao).getCustomer("john", "demo");
        defaultCustomerTest(customer);
    ...
    public void testUpdateCustomer() {
        ...
        Objects.requireNonNull(customer).setFirstName(customer.getFirstName() + "*");
        customer.setLastName(customer.getLastName() + "*");
        final Address address = new Address();
        address.setStreet(Objects.requireNonNull(customer.getAddress()).getStreet() + "*");
