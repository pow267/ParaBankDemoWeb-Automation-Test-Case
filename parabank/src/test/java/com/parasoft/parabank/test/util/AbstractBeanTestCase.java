...
public abstract class AbstractBeanTestCase<T> extends AbstractParaBankTest {
    ...
    static void assertMeetsEqualsContract(final Class<?> classUnderTest) {
        ...
        Object o2;
        try {
            o1 = classUnderTest.getDeclaredConstructor().newInstance();
            o2 = classUnderTest.getDeclaredConstructor().newInstance();
        ...
        } catch (final InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException e) {
            e.printStackTrace();
    ...
    static void assertMeetsHashCodeContract(final Class<?> classUnderTest) {
        try {
            final Field[] fields = classUnderTest.getDeclaredFields();
            for (final Field field : fields) {
                final Object o1 = classUnderTest.getDeclaredConstructor().newInstance();
    ...
    static void assertToString(final Class<?> classUnderTest) {
        Object o;
        try {
            o = classUnderTest.getDeclaredConstructor().newInstance();
    ...
    public static void toggleField(final Field field, final Object obj, final boolean on) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException {
