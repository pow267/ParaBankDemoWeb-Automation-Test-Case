...
public class MarhsalUtilTest extends AbstractParaBankDataSourceTest {
    ...
    public void testMarshal() {
        String xml = MarshalUtil.marshal(Objects.requireNonNull(marshaller), new LoanRequest());
        assertEquals(XML, xml);

        xml = MarshalUtil.marshal(new Marshaller() {
            @Override
            public void marshal(@NonNull final Object graph, @NonNull final Result result) throws IOException, XmlMappingException {
    ...
    public void testUnmarshal() {
        Object obj = MarshalUtil.unmarshal(Objects.requireNonNull(unmarshaller), XML);
        ...
        obj = MarshalUtil.unmarshal(new Unmarshaller() {
            ...
            @Override
            public @NonNull Object unmarshal(@NonNull final Source source) throws IOException, XmlMappingException {
                throw new IOException();
            }
        }, XML);
        assertNull(obj);
