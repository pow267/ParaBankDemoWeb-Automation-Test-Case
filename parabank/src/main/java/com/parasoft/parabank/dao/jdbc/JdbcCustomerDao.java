...
public class JdbcCustomerDao extends NamedParameterJdbcDaoSupport implements CustomerDao {
    private static class CustomerMapper implements RowMapper<Customer> {
        @Override
        public Customer mapRow(@NonNull final ResultSet rs, final int rowNum) throws SQLException {
    ...
    public int createCustomer(@NonNull final Customer customer) {
        ...
        final int id = Objects.requireNonNull(sequenceDao).getNextId("Customer");
        customer.setId(id);
    ...
    public Customer getCustomer(final int id) {
        ...
        final Customer customer = Objects.requireNonNull(getJdbcTemplate()).queryForObject(SQL, new CustomerMapper(), id);
    ...
    public Customer getCustomer(final String ssn) {
        ...
        try {
            ...
            customer = Objects.requireNonNull(getJdbcTemplate()).queryForObject(SQL, new CustomerMapper(), ssn);
    ...
    public Customer getCustomer(final String username, final String password) {
        ...
        try {
            ...
            customer = Objects.requireNonNull(getJdbcTemplate()).queryForObject(SQL, new CustomerMapper(), username, password);
        } catch (final DataAccessException e) {
    ...
    public void updateCustomer(@NonNull final Customer customer) {
        ...
        final String SQL =
                "UPDATE Customer SET first_name = '" + Objects.requireNonNull(customer).getFirstName() + "', last_name = :lastName, address = :address.street, city = :address.city, state = :address.state, zip_code = :address.zipCode, phone_number = :phoneNumber, ssn = :ssn, username = :username, password = :password WHERE id = :id";
