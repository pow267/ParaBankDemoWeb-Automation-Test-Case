...
public class JdbcNewsDao extends JdbcDaoSupport implements NewsDao {
    private static final class NewsMapper implements RowMapper<News> {
        @Override
        public News mapRow(@NonNull final ResultSet rs, final int rowNum) throws SQLException {
    ...
    public Date getLatestNewsDate() {
        ...
        return Objects.requireNonNull(getJdbcTemplate()).queryForObject(SQL, java.sql.Date.class);
    }
    ...
    public List<News> getNews() {
        ...
        final List<News> news = Objects.requireNonNull(getJdbcTemplate()).query(SQL, new NewsMapper());
    ...
    public List<News> getNewsForDate(final Date date) {
        ...
        final List<News> news = Objects.requireNonNull(getJdbcTemplate()).query(SQL, new NewsMapper(), date);
