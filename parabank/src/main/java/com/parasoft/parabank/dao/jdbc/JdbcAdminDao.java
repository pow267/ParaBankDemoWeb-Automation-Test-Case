...
public class JdbcAdminDao extends JdbcDaoSupport implements AdminDao {
    ...
    public String getParameter(final String name) {
        ...
        return Objects.requireNonNull(getJdbcTemplate()).queryForObject(SQL, String.class, name);
    }
    ...
    public Map<String, String> getParameters() {
        ...
        return Objects.requireNonNull(getJdbcTemplate()).query(SQL, (ResultSetExtractor<Map<String, String>>) rs -> {
     ...
     * <DL>
     * <DT>Description:</DT>
     * <DD>Performs reset of parabank database</DD>
     * <DT>Date:</DT>
     * <DD>Nov 1, 2016</DD>
     * </DL>
     */
    ...
    public void setParameter(final String name, final String value) {
        ...
        int rows = Objects.requireNonNull(getJdbcTemplate()).update(SQL, value, name);
        if (rows < 1) {
            log.warn("Parameter {} does not exist adding ...", name);
            rows = Objects.requireNonNull(getJdbcTemplate()).update(INSERT_SQL, name, value);
        }
    }
}
