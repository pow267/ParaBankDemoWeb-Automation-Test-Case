...
public class StockDataInserter extends JdbcDaoSupport implements DynamicDataInserter {
    ...
    public int getDataCount() {
        final Integer count = Objects.requireNonNull(getJdbcTemplate()).queryForObject("SELECT count(*) FROM Stock", Integer.class);
    ...
    public List<String> getSymbols() {
        ...
        return Objects.requireNonNull(getJdbcTemplate()).query(SQL, (ResultSetExtractor<List<String>>) rs -> {
    ...
    public void insertData() {
        Objects.requireNonNull(getJdbcTemplate()).update("DELETE FROM Stock");
        ...
        for (final String symbol : getSymbols()) {
            ...
            totalRows += rows;
            Objects.requireNonNull(getJdbcTemplate()).update(Objects.requireNonNull(sql));
