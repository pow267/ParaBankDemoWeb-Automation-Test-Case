...
public class SessionParamArgumentResolver implements HandlerMethodArgumentResolver {
     ...
     * does not exist, or there is no valid session for the request</DD>
     * <DT>Date:</DT>
     * <DD>Oct 13, 2015</DD>
     * </DL>
     *
     ...
     */
    protected Object extractSessionParameter(@NonNull final MethodParameter aParameter, @NonNull final NativeWebRequest aWebRequest)
        ...
        final HttpSession session = httprequest != null ? httprequest.getSession(false) : null;
        Object result = null;
        if (session != null) {
    ...
    @Override
    @Nullable
    public Object resolveArgument(@NonNull final MethodParameter aParameter, @Nullable final ModelAndViewContainer aMavContainer,
        @NonNull final NativeWebRequest aWebRequest, @Nullable final WebDataBinderFactory aBinderFactory) throws Exception {
    ...
    /** {@inheritDoc} */
    @Override
    public boolean supportsParameter(@NonNull final MethodParameter aParameter) {
