...
public class ParaBankBeanPostProcessor implements BeanPostProcessor {
     ...
     * <DL>
     * <DT>Description:</DT>
     * <DD>Ensures the custom resolver is present in the list of resolvers</DD>
     * <DT>Date:</DT>
     * <DD>Oct 15, 2015</DD>
     * </DL>
     *
    ...
    @Override
    public Object postProcessAfterInitialization(@NonNull final Object aParamObject, @NonNull final String aParamString)
    ...
    @Override
    public Object postProcessBeforeInitialization(@NonNull final Object aParamObject, @NonNull final String aParamString)
            throws BeansException {
        return aParamObject;
    }
