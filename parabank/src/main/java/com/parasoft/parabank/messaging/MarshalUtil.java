...
public final class MarshalUtil {
     ...
     */
    public static String marshal(@NonNull final Marshaller marshaller, @NonNull final Object obj) {
     ...
     */
    public static Object unmarshal(@NonNull final Unmarshaller unmarshaller, @NonNull final String xml) {
