...
public class JmsLoanProcessor implements MessageListener {
    ...
    private String getLoanResponseMessage(final LoanRequest loanRequest) {
        ...
        return MarshalUtil.marshal(Objects.requireNonNull(marshaller), response);
    }
    ...
    public void onMessage(final Message message) {
        try {
            ...
            jmsTemplate.send(Objects.requireNonNull(destinationName), session -> session.createTextMessage(getLoanResponseMessage(loanRequest)));
