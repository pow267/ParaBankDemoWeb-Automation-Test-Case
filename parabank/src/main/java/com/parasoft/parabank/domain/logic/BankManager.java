...
public interface BankManager {
     ...
     */
    int createCustomer(@NonNull Customer customer);
     ...
     */
    List<Position> getPositionsForCustomer(@NonNull Customer customer);
     ...
     * @return success
     */
    boolean updatePosition(@NonNull Position position);
     ...
     * @return success
     */
    boolean deletePosition(@NonNull Position position);
     ...
     */
    List<Account> getAccountsForCustomer(@NonNull Customer customer);
     ...
     */
    int createAccount(@NonNull Account account, int fromAccountId);
     ...
     */
    List<Transaction> getTransactionsForAccount(@NonNull Account account);
