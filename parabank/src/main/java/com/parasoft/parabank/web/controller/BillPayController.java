...
public class BillPayController {
    ...
    public List<Integer> getAccountIds(@SessionParam(Constants.USERSESSION) final UserSession userSession)
        ...
        final List<Account> accounts = bankManager.getAccountsForCustomer(Objects.requireNonNull(customer));
    ...
    public ModelAndView onSubmit(@Validated @ModelAttribute(Constants.BILLPAYFORM) final BillPayForm billPayForm,
        ...
        Objects.requireNonNull(bankManager).withdraw(billPayForm.getFromAccountId(), billPayForm.getAmount(),
            Objects.requireNonNull(messageSource).getMessage("bill.payment.to", new Object[] { billPayForm.getPayee().getName() }, locale));
