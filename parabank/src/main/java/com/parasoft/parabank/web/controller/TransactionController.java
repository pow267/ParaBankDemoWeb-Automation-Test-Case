    ...
    public ModelAndView handleRequest(@RequestParam("id") final String id) throws Exception {
        ...
        try {
            ...
            if (accessMode != null && !accessMode.equalsIgnoreCase("jdbc")) {
                transaction = Objects.requireNonNull(accessModeController).doGetTransaction(Integer.parseInt(id));
            }
        ...
        return new ModelAndView(Constants.TRANSACTION, Constants.TRANSACTION, Objects.requireNonNull(transaction));
    }
